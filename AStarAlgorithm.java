...
public class AStarAlgorithm{
	...
	/**
	 * does an A star search upon the entire map (though not if the player needs to
	 * enter a boat first, finding the fastest way to the destination
	 * node using an A Star on the map built up within learner to determine the best way.
	 * 
	 * @param learner - The learner that contains all information about the game so far
	 * @param source - the starting position
	 * @param gold - the end position
	 * @param size - the size of the board
	 * @param agent - the current agents state
	 * @return
	 */
	//search for known position, does not play moves
	...
	/**
	 * does an A star search upon the entire sea region if the player is in a boat, finding the fastest way to the destination
	 * node using an A Star on the map built up wihtin learner to determine the best way.
	 * 
	 * @param learner - The learner that contains all information about the game so far
	 * @param source - the starting position
	 * @param gold - the end position
...
private boolean foundGoal(Learner learner) {
   ...
   private double getHeuristic(Position current, Position goal ) {
	...
	/**
	 * Returns an arrayList of positions if the player can move to these positions.
	 * 
	 * @param node - the position the method tests positions around
	 * @param board - the entire board within learner
	 * @param agent - the agents current state
	 */
	...
	/**
	 * canWalkOver determines whether or not the player can walk over the adjacent positions around p,
